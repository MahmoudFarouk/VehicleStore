                    ...
                    var customers = new List<Customer>
                {
                    new Customer
                    {
                        ...
                        Vehicles = new List<Vehicle>
                        {
                            ...
                            new Vehicle { Id=2, VIN="VLUR4X20009093588",RegNo="DEF456",IsConnected=true},
                    ...
                    new Customer
                    {
                        ...
                        Vehicles = new List<Vehicle>
                        {
                            ...
                            new Vehicle { Id=5, VIN="YS2R4X20005387949",RegNo="MNO345",IsConnected=true}
                        }
                    },
                    new Customer
                    {
                        ...
                        Vehicles = new List<Vehicle>
                        {
                            ...
                            new Vehicle { Id=7, VIN="STU901",RegNo="YS2R4X20005387055",IsConnected=true}
                        }
                    },

                };

                    //customers.ForEach(c=>c.en)
