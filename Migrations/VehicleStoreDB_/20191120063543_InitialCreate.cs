        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsConnected = table.Column<bool>(nullable: false, defaultValueSql: "(CONVERT([bit],(0)))"),
                    RegNo = table.Column<string>(maxLength: 128, nullable: true),
                    VIN = table.Column<string>(maxLength: 128, nullable: true)
                },
                constraints: table =>
                {
